// Legal copy for Wire (operated by Satha / the Company).
...
export const TERMS_EN: LegalContent = {
  ...
  intro:
    "These Terms of Service (the \"Terms\") govern your use of the Wire platform, mobile applications, and related services (collectively, the \"Platform\") operated from the Kingdom of Saudi Arabia. By creating an account, requesting a tow, or accepting a trip, you agree to these Terms. If you do not agree, do not use the Platform.",
  lastUpdatedLabel: "Last updated",
  backToHome: "Back to home",
  contactHeading: "Contact us",
  contactBody:
    "Questions about these Terms can be directed to Support@wire.sa. We will respond within a reasonable time.",
  sections: [
    {
      id: "platform-role",
      heading: "1. Nature of the Platform",
      body: [
        "Wire is a technology platform that connects customers seeking roadside towing with independent, verified tow truck drivers. We are not a transportation carrier. We do not own, operate, or dispatch tow trucks. All towing services are performed by independent drivers who are solely responsible for the service, their vehicles, and compliance with applicable traffic, licensing, and insurance regulations.",
        "By using the Platform, you acknowledge that Wire acts only as an intermediary that facilitates matching, pricing, and payment between customers and drivers.",
      ],
    },
    {
      id: "eligibility",
    ...
    },
    {
      ...
      body: [
        "Payments are processed by Tap Payments, our third-party payment service provider. Wire does not store card details.",
        "When a customer accepts an offer, the price shown at acceptance — which is the driver's quoted fare — is authorized (held) on the customer's card. No platform service fee is added on top of this price; Wire's fee is deducted from the driver's fare (see Section 7). No further amount will be charged for the trip. No funds are transferred at authorization; capture occurs only when the trip is completed. The amount captured is always exactly equal to the price shown at acceptance.",
        ...
        "Customers are responsible for any fees their own bank or card issuer may charge (e.g. foreign-currency conversion). Wire does not add surcharges to the price shown at acceptance.",
      ],
    },
    {
      id: "cancellation",
    ...
    },
    {
      ...
      body: [
        "The driver is the supplier of the towing services to the customer. Wire acts as the driver's limited agent solely for the purpose of matching, invoicing, and collecting the trip price through the Platform, and remitting the driver's fare to the driver. Wire is not a party to the contract of carriage between the customer and the driver.",
        "Wire charges a platform service fee equal to fifteen per cent (15%) of the driver's quoted fare. This fee is deducted from the driver's fare; the driver receives eighty-five per cent (85%) of the driver's quoted fare. The price shown to and paid by the customer at offer acceptance is the driver's quoted fare; no platform service fee is added on top of it. Value added tax on the platform service fee is borne by Wire in accordance with Saudi tax law and is not deducted from the driver in addition to the fee. The platform service fee rate may change from time to time; any change will be communicated in advance and will not apply to trips already booked.",
        "Wire does not charge drivers a monthly subscription, a registration fee, or any other fee beyond the platform service fee described above.",
    ...
    },
    {
      ...
      body: [
        ...
        "The platform service fee that Wire charges the driver (fifteen per cent (15%) of the driver's quoted fare; see Section 7) is a service supplied by Wire to the driver and is subject to VAT per Saudi law. VAT on the Wire service fee is charged on that fee only, not on the full trip fare, and is borne by Wire.",
        "Wire does not collect or remit VAT on behalf of the driver unless a separate written collection-and-remittance agreement is entered into with that driver. Invoices and receipts issued through the Platform identify the driver as the supplier of the towing service.",
        "If a tax authority reclassifies the supply for any reason and issues an assessment against Wire for tax that is economically owed by the driver, the driver will indemnify Wire for that amount and any related penalties.",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        "All content, trademarks, software, designs, and compilations on the Platform are owned by Wire or its licensors and are protected by Saudi and international intellectual property law. You are granted a limited, revocable, non-exclusive licence to use the Platform for its intended purpose. No rights are granted by implication.",
      ],
    },
    {
      id: "disclaimer",
      ...
      body: [
        "The Platform is provided \"as is\" and \"as available\". To the maximum extent permitted by law, Wire disclaims all warranties, whether express or implied, including merchantability, fitness for a particular purpose, and non-infringement.",
        "Wire does not warrant that any particular driver will be available at any particular time, that arrival times will be exact, or that the Platform will be uninterrupted or error-free.",
      ],
    },
    {
      id: "liability",
      ...
      body: [
        "Because Wire is a matching platform and not the carrier, Wire is not responsible for damage, loss, injury, or delay caused during the towing service itself. Any claim for damage to the vehicle or property during the tow is between the customer and the driver and, where applicable, the driver's insurer.",
        "To the maximum extent permitted by law, Wire's aggregate liability arising from or related to your use of the Platform is limited to the total fees Wire has actually collected from you in the twelve (12) months preceding the event giving rise to the claim, or SAR 1,000 — whichever is greater.",
    ...
    },
    {
      ...
      body: [
        "You will defend and indemnify Wire, its officers, employees, and agents against any claim, loss, or expense (including reasonable legal fees) arising out of: your breach of these Terms; your violation of applicable law; or, for drivers, any incident occurring during the delivery of towing services you perform.",
      ],
    },
    {
      id: "termination",
      ...
      body: [
        "Wire may suspend or terminate your access to the Platform at any time, with or without notice, where we reasonably believe you have breached these Terms, created a safety risk, or engaged in fraud. You may close your account at any time through the app or by writing to Support@wire.sa.",
    ...
    },
    {
      ...
      body: [
        "If any provision of these Terms is held unenforceable, the remaining provisions remain in full force. Failure to enforce a right is not a waiver. These Terms are the entire agreement between you and Wire regarding the Platform and supersede any prior agreement on the same subject.",
...
export const TERMS_AR: LegalContent = {
  title: "شروط الخدمة",
  intro:
    "تحكم شروط الخدمة هذه (\"الشروط\") استخدامك لمنصة واير وتطبيقاتها وخدماتها ذات الصلة (\"المنصة\") المُشغّلة من داخل المملكة العربية السعودية. بإنشائك حسابًا أو طلبك سطحة أو قبولك رحلة فإنك توافق على هذه الشروط. إذا لم تكن موافقًا فلا تستخدم المنصة.",
  lastUpdatedLabel: "آخر تحديث",
  backToHome: "رجوع للرئيسية",
  contactHeading: "تواصل معنا",
  contactBody:
    "لأي استفسار عن هذه الشروط راسلنا على Support@wire.sa وسنرد خلال مدة معقولة.",
  sections: [
    {
      id: "platform-role",
      heading: "١. طبيعة المنصة",
      body: [
        "واير منصة تقنية تربط بين العملاء الذين يحتاجون خدمة سحب مركبات وبين سائقي سطحات مستقلين ومعتمدين. نحن لسنا ناقلًا ولا نملك أو نُشغّل السطحات بأنفسنا. تُقدَّم خدمة السحب من قِبل سائقين مستقلين وهم وحدهم المسؤولون عن الخدمة ومركباتهم والالتزام بالأنظمة واللوائح السارية.",
        "باستخدامك المنصة فإنك تُقرّ بأن واير تعمل فقط كوسيط يُيسّر عملية المطابقة والتسعير والدفع بين العميل والسائق.",
      ],
    },
    {
      id: "eligibility",
    ...
    },
    {
      ...
      body: [
        "تُعالج المدفوعات عبر مزود خدمة الدفع Tap Payments. لا تُخزّن واير بيانات البطاقات.",
        "عند قبول العرض يُحجز السعر الظاهر عند القبول — وهو الأجرة التي عرضها السائق — على بطاقة العميل. ولا يُضاف أي رسم خدمة على هذا السعر؛ بل يُقتطع رسم واير من أجرة السائق (انظر المادة ٧)، ولن يُستحصل أي مبلغ إضافي مقابل الرحلة. لا يتم أي تحويل فعلي عند التفويض، ويتم الاستقطاع الفعلي فقط عند إتمام الرحلة. والمبلغ المستقطَع يساوي تمامًا السعر الظاهر عند القبول.",
        ...
        "يتحمل العميل أي رسوم يفرضها بنكه أو مُصدِر بطاقته (كرسوم تحويل العملة). لا تُضيف واير أي رسوم على السعر الظاهر عند القبول.",
      ],
    },
    {
      id: "cancellation",
      ...
      body: [
        ...
        "الإلغاءات المتكررة أو غير المبررة (مثل إلغاء السائق بعد القبول للبحث عن طلب أفضل، أو إلغاء العميل بعد قطع السائق مسافة كبيرة) قد ينتج عنها تحذيرات أو إيقاف مؤقت أو إنهاء للحساب. ويجوز لواير، ضمن ما يسمح به النظام، فرض رسم إلغاء لتغطية التكاليف المعقولة.",
      ],
    },
    {
      id: "driver-obligations",
      ...
      body: [
        "السائق هو مُقدِّم خدمة السحب للعميل. وتعمل واير بصفتها وكيلًا محدود الصلاحيات عن السائق لغرض وحيد هو المطابقة وإصدار الفواتير وتحصيل ثمن الرحلة عبر المنصة وتحويل أجرة السائق إليه. وواير ليست طرفًا في عقد النقل بين العميل والسائق.",
        "تفرض واير رسم خدمة منصة يعادل خمسة عشر بالمئة (١٥٪) من الأجرة التي يعرضها السائق. يُقتطع هذا الرسم من أجرة السائق؛ ويستلم السائق خمسة وثمانين بالمئة (٨٥٪) من الأجرة التي عرضها. ويمثّل السعر الظاهر للعميل والمدفوع منه عند قبول العرض أجرة السائق المعروضة؛ ولا يُضاف عليه أي رسم خدمة منصة. وتتحمّل واير ضريبة القيمة المضافة على رسم خدمة المنصة وفق النظام السعودي، ولا تُقتطع من السائق إضافةً إلى الرسم. وقد يتغيّر رسم الخدمة من وقت لآخر؛ ويُبلَّغ عن أي تغيير مسبقًا ولا يسري على الرحلات المحجوزة.",
        "لا تفرض واير على السائق اشتراكًا شهريًا ولا رسوم تسجيل ولا أي رسم آخر يتجاوز رسم خدمة المنصة المذكور أعلاه.",
    ...
    },
    {
      ...
      body: [
        ...
        "رسم خدمة المنصة الذي تفرضه واير على السائق (خمسة عشر بالمئة (١٥٪) من الأجرة التي يعرضها السائق؛ انظر المادة ٧) هو خدمة تُقدّمها واير للسائق ويخضع لضريبة القيمة المضافة وفق النظام السعودي. وتُحتسب ضريبة القيمة المضافة على رسم خدمة واير فقط، لا على كامل أجرة الرحلة، وتتحمّلها واير.",
        "لا تُحصّل واير ضريبة القيمة المضافة ولا تُورّدها نيابةً عن السائق ما لم يُبرَم اتفاق خطي مستقل للتحصيل والتوريد مع ذلك السائق. وتُصدر الفواتير والإيصالات عبر المنصة مبينةً السائق بوصفه مُقدِّم خدمة السحب.",
        "إذا أعادت أي جهة ضريبية تصنيف التوريد لأي سبب وأصدرت ربطًا ضريبيًا على واير عن ضريبة يتحملها السائق اقتصاديًا، فإن السائق يُعوّض واير عن ذلك المبلغ وأي غرامات مرتبطة به.",
      ],
    },
    {
      id: "customer-obligations",
    ...
    },
    {
      ...
      body: [
        "جميع المحتويات والعلامات التجارية والبرمجيات والتصاميم الخاصة بالمنصة مملوكة لواير أو لمرخِّصيها ومحمية بموجب أنظمة الملكية الفكرية السعودية والدولية. يُمنح لك ترخيص محدود غير حصري وقابل للإلغاء لاستخدام المنصة للغرض المقصود منها.",
      ],
    },
    {
      id: "disclaimer",
      ...
      body: [
        "تُقدَّم المنصة \"كما هي\" و\"حسب التوفر\". في أقصى حد يسمح به النظام، تُخلي واير مسؤوليتها عن جميع الضمانات الصريحة والضمنية بما في ذلك التسويق وملاءمة غرض معين وعدم التعدي.",
        "لا تضمن واير توفر سائق معين في وقت معين، ولا دقة أوقات الوصول، ولا استمرارية المنصة دون انقطاع أو أخطاء.",
      ],
    },
    {
      id: "liability",
      ...
      body: [
        "بما أن واير منصة ربط وليست ناقلًا، فلن تكون مسؤولة عن الأضرار أو الخسائر أو الإصابات أو التأخيرات الناشئة أثناء تقديم خدمة السحب نفسها. أي مطالبة عن تلف المركبة أو الممتلكات أثناء السحب تكون بين العميل والسائق، ومُؤمِّن السائق إن وُجد.",
        "في أقصى حد يسمح به النظام، تقتصر مسؤولية واير الإجمالية الناشئة عن أو المتعلقة باستخدامك للمنصة على إجمالي الرسوم التي حصّلتها واير منك فعليًا خلال اثني عشر (١٢) شهرًا السابقة للحدث، أو ١٬٠٠٠ ريال سعودي، أيهما أكبر.",
    ...
    },
    {
      ...
      heading: "١٤. التعويض",
      body: [
        "توافق على الدفاع عن واير ومسؤوليها وموظفيها ووكلائها وتعويضهم عن أي مطالبة أو خسارة أو نفقة (بما فيها أتعاب المحاماة المعقولة) ناشئة عن: إخلالك بهذه الشروط؛ أو مخالفتك للأنظمة السارية؛ أو بالنسبة للسائق، أي حادث يقع أثناء تقديمك لخدمة السحب.",
      ],
    },
    {
      id: "termination",
      ...
      body: [
        "يحق لواير إيقاف وصولك للمنصة أو إنهاؤه في أي وقت، بإشعار أو دونه، إذا رأت بشكل معقول أنك أخللت بالشروط أو أحدثت خطرًا على السلامة أو مارست احتيالًا. ويحق لك إغلاق حسابك في أي وقت من داخل التطبيق أو بمراسلة Support@wire.sa.",
    ...
    },
    {
      ...
      body: [
        "إذا تعذّر تنفيذ أي بند من هذه الشروط تبقى بقية البنود سارية. عدم ممارسة حق لا يُعدّ تنازلًا عنه. تُمثّل هذه الشروط الاتفاق الكامل بينك وبين واير وتلغي أي اتفاق سابق في الموضوع ذاته.",
...
export const PRIVACY_EN: LegalContent = {
  ...
  intro:
    "This Privacy Policy explains how Wire (the \"Company\", \"we\", \"us\") collects, uses, discloses, and protects personal data when you use our platform, mobile applications, and related services in the Kingdom of Saudi Arabia. This Policy is written in line with the Saudi Personal Data Protection Law (PDPL) and its implementing regulations.",
  lastUpdatedLabel: "Last updated",
  backToHome: "Back to home",
  contactHeading: "Contact the Data Controller",
  contactBody:
    "For questions about your personal data or to exercise your rights, email Support@wire.sa. We reply within the statutory period set by the PDPL.",
  sections: [
    {
      id: "controller",
      heading: "1. Who we are",
      body: [
        "Wire is a technology platform that matches customers with independent tow truck drivers across Saudi Arabia. For the purposes of the PDPL we are the controller of the personal data we collect from customers and drivers through our apps and website.",
      ],
    },
    {
      id: "data-collected",
      ...
      body: [
        ...
        "Payment data: the agreed trip price, payment identifiers, authorization and capture status. Card numbers and CVV are collected and processed directly by our payment service provider (Tap Payments) and are not stored by Wire.",
    ...
    },
    {
      ...
      body: [
        ...
        "Driver KYC documents: retained for the period required by Saudi law and internal risk policy, and for the duration of the driver's relationship with Wire.",
    ...
    },
    {
      ...
      body: [
        ...
        "To exercise a right, write to Support@wire.sa from the phone number or email linked to your account. We may ask you to verify your identity. We respond within the period required by the PDPL.",
...
export const PRIVACY_AR: LegalContent = {
  ...
  intro:
    "توضح سياسة الخصوصية هذه كيف تجمع واير (\"الشركة\"، \"نحن\") بياناتك الشخصية وتستخدمها وتُفصح عنها وتحميها أثناء استخدامك لمنصتنا وتطبيقاتنا وخدماتها ذات الصلة داخل المملكة العربية السعودية. وقد صيغت هذه السياسة بما يتوافق مع نظام حماية البيانات الشخصية السعودي (PDPL) ولوائحه التنفيذية.",
  lastUpdatedLabel: "آخر تحديث",
  backToHome: "رجوع للرئيسية",
  contactHeading: "التواصل مع صاحب الصلاحية على البيانات",
  contactBody:
    "لأي استفسار حول بياناتك الشخصية أو لممارسة حقوقك راسلنا على Support@wire.sa وسنرد خلال المدة التي يحددها النظام.",
  sections: [
    {
      id: "controller",
      heading: "١. من نحن",
      body: [
        "واير منصة تقنية تربط العملاء بسائقي سطحات مستقلين في المملكة العربية السعودية. لأغراض نظام حماية البيانات الشخصية نحن صاحب الصلاحية على البيانات التي نجمعها من العملاء والسائقين عبر تطبيقاتنا وموقعنا.",
      ],
    },
    {
      id: "data-collected",
      ...
      body: [
        ...
        "بيانات الدفع: السعر المتفق عليه، معرّفات العملية، حالة التفويض والاستقطاع. أما أرقام البطاقات ورمز CVV فيُعالَجها مزود الدفع (Tap Payments) مباشرة ولا تُخزَّن لدى واير.",
    ...
    },
    {
      ...
      body: [
        ...
        "وثائق اعرف عميلك للسائق: تُحفظ للمدة المطلوبة نظامًا ووفق سياسة المخاطر الداخلية وطوال فترة علاقة السائق بواير.",
    ...
    },
    {
      ...
      body: [
        ...
        "لممارسة أي حق راسلنا على Support@wire.sa من رقم الجوال أو البريد المرتبط بحسابك. قد نطلب التحقق من هويتك، ونرد خلال المدة التي يحددها النظام.",
